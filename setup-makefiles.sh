...
PRODUCT_SPECIFIC_DEFINES += TARGET_PRELINKER_MAP=\$(TOP)/device/htc/legend/prelink-linux-arm-legend.map
...
(cat << EOF) | sed s/__DEVICE__/$DEVICE/g > ../../../vendor/htc/legend/overlay/packages/apps/Launcher2/res/layout/all_apps.xml
